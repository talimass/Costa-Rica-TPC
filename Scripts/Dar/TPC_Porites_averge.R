...
if (file.exists(xlsx_file)) {
  ...
  stop("Could not find PORITES_Photo.T.xlsx or PORITES_Photo.T.csv")
}
...
# EXPORT TABLES
# ----------------------------
write.csv(mean_dat, file.path(out_dir, "PORITES_site_mean_raw.csv"), row.names = FALSE)
write.csv(pred_tbl_export, file.path(out_dir, "PORITES_site_mean_predictions.csv"), row.names = FALSE)
write.csv(coef_tbl, file.path(out_dir, "PORITES_site_mean_coefficients.csv"), row.names = FALSE)
write.csv(params_tbl, file.path(out_dir, "PORITES_site_mean_calc_params.csv"), row.names = FALSE)
...
write_xlsx(
  ...
  file.path(out_dir, "PORITES_site_mean_rTPC_outputs.xlsx")
)
...
# MAKE PLOTS
# ----------------------------
make_site_plot("NP", "Porites NP site mean", "PORITES_site_mean_NP.png")
make_site_plot("R",  "Porites R site mean",  "PORITES_site_mean_R.png")
make_site_plot("GP", "Porites GP site mean", "PORITES_site_mean_GP.png")
